...
class Logger {
    ...
    error = (message: string, ...args: any) => this._process(LogLevel.ERROR, message, ...args)
    warning = (message: string, ...args: any) => this._process(LogLevel.WARNING, message, ...args)
    notice = (message: string, ...args: any) => this._process(LogLevel.NOTICE, message, ...args)
    info = (message: string, ...args: any) => this._process(LogLevel.INFO, message, ...args)
    debug = (message: string, ...args: any) => this._process(LogLevel.DEBUG, message, ...args)
}
